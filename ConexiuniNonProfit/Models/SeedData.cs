		...
		public static void Initialize(IServiceProvider serviceProvider)
		{
				...
				<DbContextOptions<ApplicationDbContext>>()))
			{
				...
				context.Users.AddRange(
					new ApplicationUser
					{
						Id = "11a86a11-7334-4641-9cc8-7883e2e162f0", // primary key
					...
					new ApplicationUser
					{
						Id = "b62a2678-3ee2-4f7f-9f83-b4b2dd50621e", // primary key
				...
				context.UserRoles.AddRange(
					new IdentityUserRole<string>
					{
						...
						UserId = "11a86a11-7334-4641-9cc8-7883e2e162f0"
					},

					new IdentityUserRole<string>
					{
						RoleId = "2c5e174e-3b0e-446f-86af-483d56fd7212",
						UserId = "b62a2678-3ee2-4f7f-9f83-b4b2dd50621e"
					}
				);
